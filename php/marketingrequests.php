...
uln_rate_limit('marketingrequests');
...
// Insert data
$query = "INSERT INTO marketingrequests (name, phone, description)
          VALUES ('$name', '$phone', '$description')";
$insert = mysqli_query($con, $query);

if ($insert) {
    $sourceId = (int) mysqli_insert_id($con);
    uln_notify_lead('marketing', [
        'source_id' => $sourceId,
        'name' => $name,
        'phone' => $phone,
    ...
    echo json_encode(['status' => 'success', 'message' => "$name, your marketing and SEO inquiry has been sent. Thank you!"]);
} else {
    http_response_code(500);
