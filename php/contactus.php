...
// Insert data
$query = "INSERT INTO contactus (name, phone, email, subject, message)
          VALUES ('$name', '$phone', '$email', '$subject', '$message')";
$insert = mysqli_query($con, $query);

if ($insert) {
    http_response_code(200);
    echo json_encode(['status' => 'success', 'message' => "$name, your message has been received. We'll get back to you soon. Thank you!"]);
} else {
    http_response_code(500);
