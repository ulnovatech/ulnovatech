...
// Insert data
$query = "INSERT INTO appdevrequests (name, phone, description)
          VALUES ('$name', '$phone', '$description')";
$insert = mysqli_query($con, $query);

if ($insert) {
    $sourceId = (int) mysqli_insert_id($con);
    uln_notify_lead('appdev', [
        'source_id' => $sourceId,
        'name' => $name,
        'phone' => $phone,
    ...
    echo json_encode(['status' => 'success', 'message' => "$name, your app development inquiry has been sent. Thank you!"]);
} else {
    http_response_code(500);
