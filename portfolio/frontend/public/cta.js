(function () {
  const ctaHTML = `
    <div class="top-bar">
      <a href="https://wa.me/256749594464" target="_blank" class="icon whatsapp" title="WhatsApp"></a>
  ...
  if (orderBtn) {
    ...
    const orderBase = isLocal ? "/ulnovatech/portfolio-app/order" : "/portfolio-app/order";
    orderBtn.href = orderBase + "?template=" + encodeURIComponent(templateName);
  }
})();
